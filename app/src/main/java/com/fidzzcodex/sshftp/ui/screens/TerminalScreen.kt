...
private fun androidx.compose.foundation.interaction.MutableInteractionSource.collectIsPressedAsState() =
    androidx.compose.foundation.interaction.collectIsPressedAsState(this)
